...
```{r}
data <- read_excel("Schwa data.xls")
...
Table 14/15: 'gern(e)'. There is a preference for no schwa before vowels, before unstressed, and at the start of the middlefield.
...
Table 16/17: 'heut(e)'. There is a preference for no schwa before vowel, before phrase boundary and before prefield boundare
...
anova(fitRandBase, fitRandSegment)
# the others are significant: heute/gerne behave different
anova(fitRandBase, fitRandStress) 
anova(fitRandBase, fitRandPosition)
anova(fitRandBase, fitRandBoundary)
```
